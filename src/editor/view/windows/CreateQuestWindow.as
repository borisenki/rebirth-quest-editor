...
import editor.model.vo.TypeQuestVO;
...
public class CreateQuestWindow extends Window
{
	...
	private const CREATE_QUEST:String = "Создание нового квеста";
	...
	private var _createQuest:Signal;

	public function CreateQuestWindow(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number = 0)
	{
		super(parent, xpos, ypos, CREATE_QUEST);
		_createQuest = new Signal();
		initComponents();
	}
	...
	public function getQuestType():TypeQuestVO
	{
		return _typesList.selectedItem as TypeQuestVO;
	}

	public function get createQuest():Signal
	{
		return _createQuest;
	}
}
